...
class QuizHomeView(View):
    def get(self,request,*args,**kwargs):
        ...
        return render(request,"quiz_home.html",{"cats":qs})
    
    def post(self,request,*args,**kwargs):
        cat=request.POST.get("category")
        mode=request.POST.get("mode")
        print(cat,mode)
        return redirect("question_list",cat=cat,mode=mode)
...
class QuestionListView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        random.shuffle(qs)
        return render(request,"question_list.html",{"questions":qs})
    ...
    def post(self,request,*args,**kwargs):
        ...
        return render(request,"quiz_mark.html",{"marks_obtained":marks_obtained,"question_attended":question_attended,"result":result})
    

class QuizLIstView(ListView):
    model=QuizRecord
    template_name="quiz_record.html"
